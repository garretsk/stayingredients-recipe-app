...
export default class MyPantry extends Component {
  ...
  addToPantry() {
    let path = "http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/addPantry";
  ...
  retrieveMyPantry() {
    ...
    fetch("http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/getPantry/" + name)
      .then(response => response.json())
      .then((res) => {
  ...
  markDepleted() {
    let addSLPath = "http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/addShoppingList";
    let removeMPPath = "http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/removePantry";
    let tempSelectedIngredients = [];
