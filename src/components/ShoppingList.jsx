...
export default class ShoppingList extends Component {
  ...
  addToShoppingList() {
    let path = "https://stayingredients-recipe-app.vercel.app/api/users/addShoppingList";
  ...
  retrieveShoppingList() {
    ...
    fetch("https://stayingredients-recipe-app.vercel.app/api/users/getShoppingList/" + name)
      .then(response => response.json())
      .then((res) => {
  ...
  markAsGot() {
    let addMPPath = "https://stayingredients-recipe-app.vercel.app/api/users/addPantry";
    let removeSLPath = "https://stayingredients-recipe-app.vercel.app/api/users/removeShoppingList";
    let tempSelectedIngredients = [];
