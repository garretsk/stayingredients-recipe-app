                    ...
                    <div className="card" styles="border-radius: 15px;">
                      <div className="card-body p-5">
                        ...
                        {this.state.showSocialMediaShare &&
                          <SocialMediaSharePopUp handleClose={this.handleSocialMediaSharePopUpClose} url={"https://stayingredients-recipe-app.vercel.app/shopping-list" + this.state.currentUser} quote="My StayInGredients Shopping List" hashtag="#StayInGredients"/>
                        }
                      </div>
                    </div>
                  </div>
