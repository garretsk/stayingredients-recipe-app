...
export default class SavedRecipeList extends Component {
  ...
  removeFromSavedRecipes(name, image) {
    let path = "http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/removeSavedRecipe";
  ...
  addToSavedRecipes(name, image) {
    let path = "http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/addSavedRecipe";
  ...
  retrieveSavedRecipes() {
    ...
    fetch("http://www.stayingredients-backend.us-east-2.elasticbeanstalk.com/api/users/getSavedRecipes/" + name)
